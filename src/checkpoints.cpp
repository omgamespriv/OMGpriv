...
namespace Checkpoints
{
    ...
    MapCheckpoints mapCheckpoints =
        ...
        ( 0, uint256("0x5f48b79b30389625e4587318ecbad6284332b1cf898a21fc815cc12633caa10b") ) // Params().HashGenesisBlock())
    ;

    // TestNet has no checkpoints
    MapCheckpoints mapCheckpointsTestnet =
        boost::assign::map_list_of
        ( 0, uint256("0x5f48b79b30389625e4587318ecbad6284332b1cf898a21fc815cc12633caa10b") ) // hashGenesisBlockTestNet
    ;
