...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::OMG).toInt();
    ...
    fAutoRedeemOmgX = settings.value("fAutoRedeemOmgX", false).toBool();
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemOmgX: return "AutoRedeemOmgX";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::OMG).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemOmgX: {
            fAutoRedeemOmgX = value.toBool();
            settings.setValue("fAutoRedeemOmgX", fAutoRedeemOmgX);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemOmgX() { return fAutoRedeemOmgX; }
