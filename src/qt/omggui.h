...
/**
  Omg GUI main class. This class represents the main window of the Omg UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class OmgGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit OmgGUI(QWidget *parent = 0);
    ~OmgGUI();
